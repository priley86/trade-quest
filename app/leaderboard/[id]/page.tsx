    ...
    <AppShell profile={profile} active="leaders">
      {data ? (
        ...
        <section className="empty-state">
          <h1>{player.display_name}’s collection</h1>
          <p>
            {unavailable
              ? "This portfolio is temporarily unavailable. Please try again soon."
              : "This explorer is getting their backpack ready."}
          </p>
        </section>
      )}
