...
import type { SportsProduct } from "../../../lib/cardsight";
import { searchSports } from "../../../lib/cardsight";
export async function SportsBrowser({
  query,
  sport,
}: {
  query: string;
    ...
    <>
      ...
      <form className="pokemon-search" method="get">
        ...
        <input
          name="q"
          defaultValue={query}
          placeholder="Search a player, set, or card…"
        />
        <button className="primary-button">Search</button>
      </form>
      <p className="data-note">{r.source}</p>
      <section className="pokemon-grid">
        {r.products.map((p: SportsProduct) => (
          <Link
