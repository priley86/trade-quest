...
import { searchStocks } from "../../../lib/alpaca";
    ...
    <AppShell active="trade" profile={profile}>
      ...
      <form className="pokemon-search" method="get">
        <input
          name="q"
          defaultValue={q}
          placeholder="Search a stock symbol, like AAPL…"
        />
        <button className="primary-button">Search</button>
      </form>
      <p className="data-note">Alpaca market data</p>
      {q && !results.length ? (
        <p className="form-status">
          No stock data found. Try a symbol such as AAPL.
        </p>
      ) : (
