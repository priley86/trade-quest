  ...
  return (
    <div className="app-shell">
      <header className="site-header">
        <Link href={base || "/"} aria-label="TradeQuest home">
          <Image
            src="/nav-logo.svg"
            width={214}
            height={52}
        ...
        <nav aria-label="Main navigation">
          ...
          <Link
            className={active === "leaders" ? "active" : ""}
      ...
      <main>
        {demo && (
          <div className="demo-banner">
            <b>Demo quest</b> · Sample players and pretend balances.{" "}
            <Link href="/invite/demo-quest">Preview signup</Link>
          </div>
        )}
        {children}
      </main>
